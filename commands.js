import { tryGetUser, getRandomInt, makeCombid, DiscordRequest, } from "./utils.js";
...
export const commands = [
    {
        toRunfunction: async (res, req, prisma) => {
            ...
            if (data["options"] === undefined) {
                ...
                let tmpamount = data["options"][0]["value"];
                try {
    ...
    },
    {
        toRunfunction: async (res, req, prisma) => {
            ...
            if (data["options"] === undefined) {
                ...
                let { username, discriminator } = await (await DiscordRequest(Routes.user(data["options"][0]["value"]), { method: "GET" })).json();
